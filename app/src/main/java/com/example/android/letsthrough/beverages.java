...
public class beverages  extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productReference= FirebaseDatabase.getInstance().getReference().child("Beverages");
    ...
    {
        Intent intent=new Intent(beverages.this, AccountMainActivity.class);
            ...
            protected void populateViewHolder(beveragesHolder viewHolder, Products model,final int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mEditor.commit();
                        mEditor.apply();
                        Intent i=new Intent(beverages.this,Details.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                // API 5+ solution
                Intent i=new Intent(beverages.this,MainActivity.class);
                startActivity(i);
                return true;
    ...
    { Intent intent = new Intent(beverages.this, fruits.class);
        startActivity(intent);}

    public void openVegetables(View view)
    { Intent intent = new Intent(beverages.this, Vegetables.class);
        startActivity(intent);}

    public void openHousehold(View view)
    { Intent intent = new Intent(beverages.this, Household.class);
        startActivity(intent);}
